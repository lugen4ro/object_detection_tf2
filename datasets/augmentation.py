...
def expand_image(img, gt_boxes, height, width):
    ...
    modified_gt_boxes = utils_bbox.renormalize_bboxes_with_min_max(gt_boxes, min_max)
    #
...
def patch(img, gt_boxes):
    ...
    gt_boxes = utils_bbox.renormalize_bboxes_with_min_max(gt_boxes, new_boundaries[0, 0])
    #
    return img, gt_boxes
